<%@ Page Title="产品列表" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListProduct.aspx.cs" Inherits="DotNetSoft.Web.Admin.Product.ListProduct" %>
