...
namespace DBUtility
{
    ...
    public sealed class SqlHelper
    {
        ...
        //BBS数据库
        public static readonly string SqlProviderBbsConnString = ConfigurationManager.ConnectionStrings["SqlProviderBbsConnString"].ConnectionString;
        ...
        /// <param name="parameterValues">Array of objects holding the values to be assigned 将要分配给存储过程参数的对象数组</param>
