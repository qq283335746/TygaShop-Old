<%@ Page Title="新建/修改产品信息" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="DotNetSoft.Web.Admin.Product.AddProduct" %>
