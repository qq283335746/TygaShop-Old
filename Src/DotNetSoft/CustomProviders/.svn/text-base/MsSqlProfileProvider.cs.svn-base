    ...
    public class MsSqlProfileProvider : ProfileProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (string.IsNullOrEmpty(config["description"]))
            {
                ...
                config.Add("description", SecurityMessage.GetString(SecurityMessage.ProfileSqlProvider_description));
            }
        ...
        public override int DeleteInactiveProfiles(ProfileAuthenticationOption authenticationOption, DateTime userInactiveSinceDate)
        {
            ...
            object o = SqlHelper.ExecuteScalar(SqlHelper.SqlProviderConnString, CommandType.StoredProcedure, cmdText, parms);
            if (o == null || !(o is int))
                return 0;
            return (int)o;
        }
        ...
        public override int DeleteProfiles(ProfileInfoCollection profiles)
        {
            ...
            if (profiles.Count < 1)
            {
                throw new ArgumentException(
                    SecurityMessage.GetString(
                        SecurityMessage.Parameter_collection_empty,
                        "profiles"),
                    "profiles");
            }
        ...
        private static void CheckUserName(string userName)
        {
            if (string.IsNullOrEmpty(userName) || userName.Length > 256 || userName.IndexOf(",") > 0)
                throw new ApplicationException(SecurityMessage.GetString(SecurityMessage.Provider_Invalid_Parameter, "user name"));
        }
