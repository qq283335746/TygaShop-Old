...
namespace DotNetSoft.DAL.MsSqlProvider
{
    public class Product : IProduct
    {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public int Update(Model.Product model)
        {
            if (model == null) return -1;
        ...
        /// <param name="numberId"></param>
        /// <returns></returns>
        public Model.Product GetModel(string numberId)
        {
        ...
        /// <returns></returns>
        public IList<Model.Product> GetList(int pageIndex, int pageSize, out int totalCount, string sqlWhere, params SqlParameter[] commandParameters)
        {
            //获取数据集总数
        ...
        /// <returns></returns>
        public IList<Model.Product> GetImagesListInProductIds(string productIds)
        {
            IList<Model.Product> list = null;
        ...
        public List<Model.Product> GetProductsBySearch(string[] keywords)
        {
            List<Model.Product> list = new List<Model.Product>();
        ...
        public List<Model.Product> GetProducts(int pageIndex, int pageSize, out int totalCount, string sqlWhere,string orderBy, params SqlParameter[] commandParameters)
        {
            List<Model.Product> list = new List<Model.Product>();
        ...
        public List<Model.Product> GetProductsInCategories(string categories)
        {
            List<Model.Product> list = new List<Model.Product>();
