<%@ Page Title="天涯孤岸软件-电子商务软件" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListDiamond.aspx.cs" Inherits="DotNetSoft.Web.Shares.ListDiamond" %>
...
<div class="sr">
    <div class="c">
    <div class="ca">
        <div class="cad"><a href="#" class="caa">所有分类</a>&nbsp;&gt;&nbsp;钻石</div>
    </div>
    ...
    <div id="goods" class="e" style="margin-top:17px;">
        <asp:Repeater runat="server" ID="rpData">
            <ItemTemplate>
                <div class="f">
                    <div class="fborder">
                        <div class="fa" style='<%#string.Format("background-image:url({0})", VirtualPathUtility.MakeRelative("~/Shares/ListDiamond.aspx", Eval("ImagesUrl").ToString()))%>'></div>
                    </div>
