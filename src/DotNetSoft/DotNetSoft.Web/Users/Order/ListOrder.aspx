<%@ Page Title="我的订单" Language="C#" MasterPageFile="~/Users/Users.Master" AutoEventWireup="true" CodeBehind="ListOrder.aspx.cs" Inherits="DotNetSoft.Web.Users.Order.ListOrder" %>
...
<asp:Repeater ID="rpData" runat="server" OnItemDataBound="rpData_ItemDataBound">
    <HeaderTemplate>
        <table id="bindT" class="easyui-datagrid" title="订单列表" data-options="rownumbers:true,toolbar:'#tb'" style="height:auto;">
        <thead>
            <tr>
                ...
                <th data-options="field:'f10'">操作</th>
            </tr>
        </thead>
        <tbody>
    </HeaderTemplate>
    <ItemTemplate>
            <tr>           
                ...
                <td>
                  <a href='ShowOrder.aspx?oN=<%#Eval("OrderNum")%>' target="_blank">查看</a>
                  <a runat="server" id="aPay" href='<%#Eval("OrderNum","AddOrderSucceed.aspx?oN={0}") %>' target="_blank" visible="false">继续付款</a>
                </td>
            </tr>
    </ItemTemplate>
