<%@ Page Title="论坛内容列表" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListContent.aspx.cs" Inherits="DotNetSoft.Web.Admin.BBS.ListContent" %>
