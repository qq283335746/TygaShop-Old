<%@ Page Title="角色列表" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListRoles.aspx.cs" Inherits="DotNetSoft.Web.Admin.Members.ListRoles" %>
