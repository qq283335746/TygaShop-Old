...
namespace DotNetSoft.DAL.MsSqlProvider
{
    public class ContentDetail : IContentDetail
    {
        ...
        /// <param name="numberId"></param>
        /// <returns></returns>
        public Model.ContentDetail GetModel(string numberId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Model.ContentDetail> GetList()
        {
            List<Model.ContentDetail> list = new List<Model.ContentDetail>();
        ...
        /// <returns></returns>
        public List<Model.ContentDetail> GetSiteContent(string typeName)
        {
            List<Model.ContentDetail> list = new List<Model.ContentDetail>();
