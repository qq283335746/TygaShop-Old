<%@ Page Title="新建/修改收货地址" Language="C#" MasterPageFile="~/Users/Users.Master" AutoEventWireup="true" CodeBehind="AddAddress.aspx.cs" Inherits="DotNetSoft.Web.Users.AddAddress" %>
