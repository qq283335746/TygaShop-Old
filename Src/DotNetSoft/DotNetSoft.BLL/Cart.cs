...
namespace DotNetSoft.BLL
{
    ...
    public class Cart
    {
        ...
        private Dictionary<string, Model.CartItemInfo> cartItems = new Dictionary<string, Model.CartItemInfo>();
        ...
        public decimal TotalPrice
        {
            ...
            {
                decimal total = 0;
                foreach (Model.CartItemInfo item in cartItems.Values)
        ...
        {
            int count = 0;
            foreach (Model.CartItemInfo model in cartItems.Values)
            {
        ...
        public ICollection<Model.CartItemInfo> CartItems
        {
