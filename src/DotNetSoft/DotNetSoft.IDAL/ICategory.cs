...
namespace DotNetSoft.IDAL
{
    public interface ICategory
    {
        ...
        /// <returns></returns>
        int Insert(Model.Category model);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        int Update(Model.Category model);
        ...
        /// <returns></returns>
        Model.Category GetModel(string numberId);
        ...
        /// <returns></returns>
        List<Model.Category> GetCategoryByTitle(string title);
        ...
        /// <returns></returns>
        IList<Model.Category> GetListInParentIds(string parentIdsAppend);
