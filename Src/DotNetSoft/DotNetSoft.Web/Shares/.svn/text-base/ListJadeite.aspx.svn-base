<%@ Page Title="天涯孤岸软件-OA办公软件" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListJadeite.aspx.cs" Inherits="DotNetSoft.Web.Shares.ListJadeite" %>
