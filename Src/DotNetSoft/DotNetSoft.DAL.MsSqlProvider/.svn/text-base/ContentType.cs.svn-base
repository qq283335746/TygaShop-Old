...
namespace DotNetSoft.DAL.MsSqlProvider
{
    public class ContentType : IContentType
    {
        ...
        /// <returns></returns>
        public IList<Model.ContentType> GetList(int pageIndex, int pageSize, out int totalCount, string sqlWhere, params SqlParameter[] commandParameters)
        {
            //获取数据集总数
			...
			IList<Model.ContentType> list = null;
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.SqlProviderConnString, CommandType.Text, cmdText, commandParameters))
            {
                ...
                {
                    list = new List<Model.ContentType>();
        ...
        /// </summary>
        /// <returns></returns>
        public List<Model.ContentType> GetList()
        {
            List<Model.ContentType> list = new List<Model.ContentType>();
