...
namespace DotNetSoft.WebHelper
{
    public class ProductDataProxy
    {
        ...
        public static List<Model.Product> GetProductsByCategory(string category)
        {
            ...
            List<Model.Product> data = (List<Model.Product>)HttpRuntime.Cache[key];
        ...
        public static List<Model.Product> GetProductsBySearch(string text)
        {
            BLL.Product bll = new BLL.Product();
        ...
        public static Model.Product GetProduct(string productId)
        {
            BLL.Product bll = new BLL.Product();
            ...
            Model.Product data = (Model.Product)HttpRuntime.Cache[key];
        ...
        public static List<Model.Product> GetProducts(int pageIndex, int pageSize, out int totalCount)
        {
            BLL.Product bll = new BLL.Product();
            totalCount = 0;
