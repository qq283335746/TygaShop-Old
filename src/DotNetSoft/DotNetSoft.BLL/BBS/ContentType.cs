...
using DotNetSoft.IDAL.Bbs;

namespace DotNetSoft.BLL.Bbs
{
    public class ContentType
    {
        private static readonly IContentType dal = DALFactory.DataAccess.CreateBbsContentType();
        ...
        /// <param name="numberId"></param>
        /// <returns></returns>
        public Model.Bbs.ContentType GetModel(string numberId)
        {
