...
namespace DotNetSoft.IDAL
{
    public interface ISearchKeyword
    {
        ...
        /// <returns></returns>
        int Insert(Model.SearchKeyword model);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        int Update(Model.SearchKeyword model);
        ...
        /// <param name="numberId"></param>
        /// <returns></returns>
        Model.SearchKeyword GetModel(string numberId);
        ...
        /// <returns></returns>
        IList<Model.SearchKeyword> GetList(int pageIndex, int pageSize, out int totalCount, string sqlWhere, params SqlParameter[] commandParameters);
